                ...
                <table width="0">
                    ...
                    <c:forEach items="${photos}" var="photo">
                        <c:if test="${i%4==0}">
                            ...
                            <td>
                                <span class="button photoBtn" style="padding-right: 0px;padding-left: 0px;">
                                    <img class="hrefImg media-object" src = "${photo.photoRef}" style="width:120px; height:80px; display: inline-block; margin-top: 10px; margin-left:10px;">
                                </span>
                            </td>
                        <c:if test="${i%4==3}">
                            </tr>
