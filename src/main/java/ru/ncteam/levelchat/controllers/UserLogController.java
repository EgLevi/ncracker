...
public class UserLogController {
    ...
    public String editUserInfo(@ModelAttribute("usersLog") @Valid UserInfo userInfo,
                                 BindingResult result,
                                 Model model) {
        if (result.hasErrors()) {
            String code;
        ...
        if (userLogService.editUserInfo(userInfo).equals("success")) {
            return "edituserinfo";
        }
        return "redirect:/edituserinfo?error";
